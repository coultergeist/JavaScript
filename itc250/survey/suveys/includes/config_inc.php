...
define('VIRTUAL_PATH', 'http://velvetriot.com/school/itc250/sp17/'); # Virtual (web) 'root' of application for images, JS & CSS files
define('PHYSICAL_PATH', '/home/dancou18/velvetriot.com/school/itc250/sp17/'); # Physical (PHP) 'root' of application for file & upload reference
...
define('SUPPORT_EMAIL', 'velvetriotinfo@gmail.com'); # Email of site support
define('PREFIX', 'sp17_'); #Prefix to add uniqueness to your DB table names.  Limits hackability, naming collisions
...
include INCLUDE_PATH . 'session_db_inc.php'; #Uses a database to store session info, and override default file/cookie based session handler
...
$config->style = 'flatly.css'; #currently only Bootswatch Theme uses style to switch look & feel
