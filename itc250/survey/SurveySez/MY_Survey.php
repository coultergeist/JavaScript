...
class MY_Survey extends Survey
{
	...
	public static function responseList($id)
	{
        $myReturn = "";  
        $id = (int)$id;
		$sql="select ResponseID, SurveyID, DateAdded from sp17_responses where SurveyID=$id";
        ...
        {#records exist - process
            ...
            $myReturn .= '<table class="table table-striped table-hover table-responsive">
                      <thead>
                        <tr>
                          <th>Response Date</th>
                        </tr>
            ...
            $myReturn .= "<div align=center>Hmm... we didn't find any surveys here</div>";	
        }
